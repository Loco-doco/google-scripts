class DevPublishedGlobal {
  constructor() {
    this.sa = SpreadsheetApp.openByUrl(
      "https://docs.google.com/spreadsheets/d/19htI--DAUe8y-2j3ECmU0IQwc8Nr4mXjgZv9vzaxGTY/edit?usp=sharing"
    );
    ...
    this.protection = this.wordSheet.getProtections(
