class UpdateWord extends ManageWords{
  ...
  get_col_info(col, env){
    const colCodeEnum = {
      "1" : [env.colObj.value_kr,env.colObj.kr_updated_at,env.colObj.value_kr_name],
      "2" : [env.colObj.value_en,env.colObj.en_updated_at,env.colObj.value_en_name],
      "3" : [env.colObj.value_jp,env.colObj.jp_updated_at,env.colObj.value_jp_name],
      "4" : [env.colObj.value_es,env.colObj.es_updated_at,env.colObj.value_es_name],
      "5" : [env.colObj.value_zh_ZH,env.colObj.zh_ZH_updated_at,env.colObj.value_zh_ZH_name],
      "6" : [env.colObj.value_zh_TW,env.colObj.zh_TW_updated_at,env.colObj.value_zh_TW_name],
    }


    if(!Object.keys(colCodeEnum).includes(col)) throw new Error("올바르지 않은 값입니다.")
